...
<head>
    <title><? echo lang('welcome'); ?> | FlipGram</title>
    <meta charset="UTF-8">
    <meta name="description" content="FlipGram is a social network platform helps you meet new friends and stay connected with your family and with who you are interested anytime anywhere.">
    <meta name="keywords" content="homepage,main,login,social network,social media,FlipGram,meet,free platform">
    <meta name="author" content="Munaf Aqeel Mahdi">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <?php include "includes/head_imports_main.php";?>
</head>
    <body class="login_signup_body" style="background:repeating-radial-gradient(circle, rgba(204,19,19,1) 20%, rgba(70,252,232,1)50%);">
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks"><img style="width: 85px; height:25px" src="imgs/FlipGram.png " ></a>
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> <img style="width: 95px; height:30px" src="imgs/FlipGram.png " ></h3>
        <p align="center" style="color: #999; margin-bottom: 25px;"><? echo lang('FlipGram_main_string'); ?>.</p>
            <div style="display: flex;">
                ...
                <div style="width: 100%;text-align: center;">
                    <img src="imgs/main_icons/pc_main.png" alt="FlipGram" style="width: 300px;" />
                </div>
            </div>
        </div>
